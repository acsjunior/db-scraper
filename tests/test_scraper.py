...
MOCK_SONG_DATA = [
    {
        'data_id': '62582', 'titulo': 'É Mato', 'autor': 'Wilson Batista / Alvaiade',
        'interprete': 'Odete Amaral', 'disco': 'Odeon 12071',
        'ano_lancamento_disco': '1941', 'data_gravacao': '13 Outubro 1941',
        'data_lancamento': 'Dezembro 1941', 'audio_url': 'http://fake.url/audio/62582.mp3'
    }
]
...
class TestFileOperations:
    ...
    def test_save_playlist_to_csv(self, mocker, tmp_path):
        ...
        """
        mocker.patch('src.db_scraper.scraper.extract_playlist_data', return_value=MOCK_SONG_DATA)
